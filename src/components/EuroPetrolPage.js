	...
	render () {
		return (
			<div className="smart-page">
				...
				<section id="2_section" className="full-one ep-grey-background " id="section1">
					<div className="cont flex1">
						...
						<div className="ep-center">
							<video controls="controls" width="760" height="428">
                                <source src="video/euro-petrol-video.mp4" type="video/mp4"/>
							</video>
						</div>
					</div>
				</section>
				...
				<section className="top-20 relative-pos">
					<img className="right img-992" src="/img/ep-bilbord.jpg"/>
					<div className="cleardiv"></div>
				</section>

				<section className="full-nine">
					<div className="cont">
