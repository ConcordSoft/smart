					...
					<div className="black-wrapper" id="section4">
						<div className="black">
							<div className="text-box-black">
								...
								<p className="orange text top-padding">Vino inspiriše. I one koji u njemu uživaju i nas koji imamo zadatak da kroz oglasna rešenja dočaramo njegovu snagu i kvalitet. Vina Vinarije Zvongo Bogdan pomeraju enološke granice, Smart  o tome govori slikama i kreativnim porukama.</p>
							</div>
						</div>
